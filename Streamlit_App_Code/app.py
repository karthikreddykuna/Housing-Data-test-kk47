...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/Housing-Data-test-kk47/master/Streamlit_App_Code/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -54487.14186411215
exported_pipeline = DecisionTreeRegressor(max_depth=9, min_samples_leaf=20, min_samples_split=20)
...
######################
# User defined values
title = 'Housing Data Demo for Streamlit Demo Version'
encoder_location = 'https://github.com/karthikreddykuna/Housing-Data-test-kk47/blob/master/Streamlit_App_Code/encoder.pkl?raw=true'
